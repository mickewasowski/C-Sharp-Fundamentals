...
namespace P06_Sneaking
{
    public class StartUp
    {
        ...
        static void Main()
        {
            ...
            GetMatrix(ref room, ref n);

            var moves = Console.ReadLine().ToCharArray();

            int[] samPosition = new int[2];

            GetSamPossition(ref samPosition);
            ...
            {
                MoveEnemies(ref room, ref moves);
        ...
        private static void MoveEnemies(ref char[][] room, ref char[] moves)
        {
            for (int row = 0; row < room.Length; row++)
            {
                for (int col = 0; col < room[row].Length; col++)
        ...
        private static void GetSamPossition(ref int[] samPosition)
        {
            for (int row = 0; row < room.Length; row++)
            {
                for (int col = 0; col < room[row].Length; col++)
        ...
        private static void GetMatrix(ref char[][] room,ref int n)
        {
